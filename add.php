...
<body>
    ...
    <p>Silahkan diisi form untuk menambahkan data mahasiswa baru informatika ITERA 2021</p>
        ...
        <fieldset>
            ...
            <table>
                ...
                <tr>
                    <td>Asal SMA</td>
                    <td>:</td>
                    <td><input type="text" id="sma" name="sma"></td>
                </tr>
                <tr>
                    <td>Email</td>
                    <td>:</td>
            ...
            <div id="btn_add"><button type="submit" name="submit">Tambah Data</button></div>
        </fieldset>
    </form>
</body>
</html>	